...
from helpers.cf_estimate import *
...
for dir_date in lst_dir:
    ...
    # Tirar arquivos superexpostos (_11) e manter as "normais" (_11)
    files = Aux.filter_filelist(files, '_12.jpg')
    # Criar tabela com dados
    #df_clouds = Aux.create_df(['Timestamp', 'Cloud_Fraction', 'Class_Sky'])
    # Criar tabela com estatísticas
    df_stats = Aux.create_df(['Timestamp', 'CF', 'Mask1_0', 'Mask1_255', 'Entropia', 'HTW',
    ...
    for filename in files:
        ...
        if res:
            ...
            #clouds_info = [date_ts, cf_asi]
            stat_info = [date_ts, cf_asi, counts_mask.get(0), counts_mask.get(255), entropia, htw,
                        criterio_homogeneidade, p_yellow, n_gray, n_white, n_black]
            print(stat_info)
            # Imprimir se for ASI de céu claro
            if cf_asi < 5:
                print('Céu claro')
